...
import { ViewType, TransactionType, PaymentStatus, PocketType, ClientStatus, LeadStatus, ContactChannel, CardType, PerformanceNoteType, SatisfactionLevel, RevisionStatus, Notification, SocialMediaPost, PostType, PostStatus, PromoCode, SOP, ClientType, ProjectStatusConfig, VendorData, BookingStatus, ChatTemplate } from './types';
...
export const NAV_ITEMS = [
    ...
    { view: ViewType.CLIENTS, label: 'Klien Pengantin', icon: UsersIcon },
    { view: ViewType.PROJECTS, label: 'Pekerjaan Wedding', icon: FolderKanbanIcon },
    { view: ViewType.TEAM, label: 'Freelancer', icon: BriefcaseIcon },
    { view: ViewType.FINANCE, label: 'Pembayaran', icon: DollarSignIcon },
    { view: ViewType.CALENDAR, label: 'Jadwal Wedding', icon: CalendarIcon },
    { view: ViewType.PACKAGES, label: 'Paket Foto', icon: PackageIcon },
    { view: ViewType.CONTRACTS, label: 'Kontrak', icon: FileTextIcon },
    { view: ViewType.PROMO_CODES, label: 'Voucher', icon: LightbulbIcon },
    { view: ViewType.SOP, label: 'Alur Kerja', icon: BookOpenIcon },
