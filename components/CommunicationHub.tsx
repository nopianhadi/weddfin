...
Kami ingin memberikan update progress proyek Anda:
...
export const CommunicationHub: React.FC<CommunicationHubProps> = ({
    ...
    const processTemplate = (template: string) => {
        ...
        if (activeProject) {
            ...
            // Calculate progress
            const statusConfig = ['Dikonfirmasi', 'Editing', 'Cetak', 'Dikirim', 'Selesai'];
    ...
    const communicationHistory = [
        ...
        },
        {
            ...
            message: 'Update progress proyek',
            status: 'sent'
        },
    ];
